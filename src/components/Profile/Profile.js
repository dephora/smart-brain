...
class Profile extends Component {
  // typically wouldn't put props in state unless the prop
  // is seed data for the components internal state
  constructor(props) {
    super(props)
    this.state = {
        ...
        <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
          <main className="pa4 black-80 w-80">
            ...
            <div className="mt4" style={{ display: 'flex', justifyContent: 'space-evenly' }}>
              <button className="b pa2 grow pointer hover-white w-40 bg-blue b--black-20">Save</button>
